...
LoanParameters.prototype.write = function(output) {
  ...
  if (this.startDate !== null && this.startDate !== undefined) {
    output.writeFieldBegin('startDate', Thrift.Type.I32, 3);
    output.writeI32(this.startDate);
    output.writeFieldEnd();
  }
  if (this.closeDate !== null && this.closeDate !== undefined) {
    output.writeFieldBegin('closeDate', Thrift.Type.I32, 4);
    output.writeI32(this.closeDate);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
